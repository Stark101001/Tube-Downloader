...
class Downloader(object):
    ...
    def about_page(self):
        self.about_lab=Label(self.about_tab,text="Here You Can Download Youtube Video.",font=('arial',11,'bold')).place(x=10,y=0)
        self.about_lab = Label(self.about_tab, text='"Thankyou"',font=('arial', 25, 'bold')).place(x=55, y=110)
